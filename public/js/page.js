...
function saveContents(){
    ...
    $.post("/edit/" + page + "?format=api", { "contents" : $("#appData").val() }).done(function() {
...
$(document).ready(function(){
    ...
    $("#link").click(function(){
        showLB("...");
        $(".lbC .c").load("/__pages?format=editor");
        return false;
    });
    $("#existImage").click(function(){
        showLB("...");
        $(".lbC .c").load("/__gallery?format=editor");
        return false;
    });
            ...
            lines.forEach(function(line){
                if(line.indexOf("[app") == 0 && lno == 0){
                    ...
                    img.mouseover(function(){
                        showPB("<img src='/img/"+$(this).data("img")+"' />", this);
                    });
